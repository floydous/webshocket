...
class server:
    ...
    state: ServerState
    def subscribe(
        self, client: "ClientConnection", channel: str | Iterable
    ) -> None: ...
    def unsubscribe(
        self, client: "ClientConnection", channel: str | Iterable
    ) -> None: ...
    ...
    async def _handler(
        self, websocket_protocol: websockets.ServerConnection
    ) -> None: ...
    ...
    @property
    def _reversed_channel(self) -> dict["ClientConnection", set[str]]: ...
